package com.javatar.virus.keydialog;

import com.javatar.virus.AppController;
...
public class KeyDialog extends JDialog {
    ...
    public KeyDialog(AppController appController) {
        setTitle("Enter key");
    ...
    private void setupListeners() {
        buttonOK.addActionListener(e -> {
            if (keyField.getText().equals(AppController.KEY)) {
                accept = true;
            }
            this.onAction();
        });
    ...
    public void onAction() {
        setVisible(false);
        appController.onKeyDialogAction();
    }
